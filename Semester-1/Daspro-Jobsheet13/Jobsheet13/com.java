...
public class com {
    ...
    public static void tambahDataKRS(Scanner scanner, String[][] dataMahasiswa, int[] totalSKS, int jumlahData) {
        ...
        String[] mataKuliahList = new String[10]; // Array untuk menyimpan nama mata kuliah (maksimum 10 mata kuliah)
        int mataKuliahCount = 0; // Counter untuk jumlah mata kuliah yang ditambahkan
        ...
        while (lanjut) {
            ...
            dataMahasiswa[jumlahData][3] = namaMK;
            ...
            // Menyimpan nama mata kuliah dalam array
            mataKuliahList[mataKuliahCount] = namaMK;
            mataKuliahCount++;
            ...
            if (pilih.equalsIgnoreCase("t")) {
                ...
                // Menampilkan semua nama mata kuliah yang diambil
                System.out.println("Nama Mata Kuliah yang diambil: ");
                for (int i = 0; i < mataKuliahCount; i++) {
                    System.out.println(mataKuliahList[i]);
                }
            }
        }
